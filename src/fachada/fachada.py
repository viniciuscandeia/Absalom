        ...
        while True:
            ...
            if self.usuario_autenticado.tipo == "administrador":
                match retorno:
                    ...
                    case "3":
                        self.telas.proxima_tela("listar_usuarios_tela_administrador")
        ...
        while True:
            ...
            match retorno:
                case "1":
                    ...
                    dados: list[Usuario] = self.repositorio.listar(tipo="administrador")
    ...
    def listar_usuarios_tela_gerente(self):
        while True:
            ...
            match retorno:
                case "1":
                    self.telas.proxima_tela("listar")
                    dados: list[Usuario] = self.repositorio.listar(id_loja=self.usuario_autenticado.id_loja)
                    self.telas.enviar_conteudo(dados)
                    self.listar_administradores()
                case "2":
                    self.telas.proxima_tela("filtrar")
